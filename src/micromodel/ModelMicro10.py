...
# 10 different classes. This model is based on CIFAR-10
...
class ModelMicro10(ModelMicro):
    ...
    @classmethod
    def create_untrained(cls, model_name: str) -> "ModelMicro10":
        save_dir = os.path.join(os.getcwd(), 'micromodel', 'saved_models', 'micro10')
        ...
        return ModelMicro10(model_path=model_path)

    @classmethod
    def load(cls, model_name: str) -> "ModelMicro10":
        save_dir = os.path.join(os.getcwd(), 'micromodel', 'saved_models', 'micro10')
        return ModelMicro10(model_path=os.path.join(save_dir, model_name))
